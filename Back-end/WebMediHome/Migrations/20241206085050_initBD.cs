    ...
    public partial class initBD : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Professionals", x => x.IdProfessional);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientsProfessional", x => new { x.ClientId, x.ProfessionalId });
                    table.ForeignKey(
                        name: "FK_ClientsProfessional_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "IdClient",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientsProfessional_Professionals_ProfessionalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientsProfessional_ProfessionalId",
                table: "ClientsProfessional",
